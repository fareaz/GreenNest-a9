...
function PlantOfTheWeek() {
  ...
  return (
     <div className="mx-2 border rounded-2xl shadow-md p-6 mt-8  gap-6  border-emerald-200 bg-emerald-50/50">
      ...
      <div className="py-5 ">
        ...
        <div className="mt-5 space-y-5  ">
          <p className="flex items-center justify-center md:justify-start gap-2">
            ...
            <span className="text-lg font-semibold text-green-800">Rating:</span><p className="text-green-600">{plant.rating}</p> 
          </p>

          <p className="flex items-center justify-center md:justify-start gap-2 ">
            <FaUserAlt className="text-green-900" />
            <span className="text-lg font-semibold text-green-800">Provider:</span> <p className="text-green-600">{plant.providerName}</p>
          </p>
        </div>
